...
export default function HeroSection() {
  return (
    <section className="hero-grid relative isolate flex min-h-[min(900px,100svh)] overflow-hidden bg-[#0b0b0e] pt-24 text-white">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-px bg-linear-to-r from-purple-500 via-white/20 to-teal-400" />
    </section>
  );
}
